...
class BotMatheux(Bot):
    ...
    # + coef de bluff est bas + le bots bluff, il évolue entre 0 et +infini
    def speaks(self, amount_to_call, blind=False):
        """Ce bots fait uniquement en fonction des stats associées à ses cartes"""
        player_action = ''
